                ...
                foreach ($items as $item) : ?>
                    ...
                    <tr>
                        <td>
                            ...
                            <?php } else { ?>
                                <a href="<?php site_url('Visiteur/voir_un_produit/' . $item['id']) ?>"><img src="<?php echo base_url('/assets/images/nonimage.jpg') ?>" width="80" /></a>
                            <?php } ?>
                        </td>
                        <td><a href="<?php site_url('Visiteur/voir_un_produit/' . $item['id']) ?>"><?php echo $item['name']; ?></a></td>
